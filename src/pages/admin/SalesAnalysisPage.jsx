...
const CHECKINS_URL = `${import.meta.env.VITE_API_BASE_URL || "http://localhost:3000"}/api/checkins/all`;
    ...
    <div className="admin-page">
      ...
      <div className="admin-layout">
        ...
        <main className="admin-main">
          ...
          {/* Interactive Daily Sales & Profit Chart */}
          <DailySalesChart salesData={salesData} checkInData={checkInData} />
